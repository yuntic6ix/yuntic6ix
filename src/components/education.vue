                ...
                <div class="container">
                    <div class="grid grid-cols-1" data-aos="fade-up">
                        <div class="text-center">
                            ...
                            <h2 class="font-semibold text-[26px]/normal mt-7">私の子供時代の紹介</h2>
                            <p class="mt-5 text-gray max-w-[708px] mx-auto">An introduction to my childhood!</p>
                        </div>
                    </div>
                                            ...
                                            <div class="space-y-5 ltr:text-left rtl:text-right ltr:md:text-right rtl:md:text-left">
                                                ...
                                                <div class="mt-7">
                                                    <div class="flex flex-col justify-end gap-4 lg:flex-row lg:items-center lg:gap-12">
                                                        <span class="font-semibold text-warning">幼稚園期</span>
                                                        <span class="text-xl font-semibold">Kindergarten Period</span>
                                                    </div>
                                                    <p class="mt-5 text-gray">公園や近所で外遊びもしていたはずですが家遊びの記憶が強く残っていました。お気に入りのお遊戯会の写真（衣装がほつれているのがポイント）</p>
                                                    <p class="mt-6 font-semibold">SATSUKI KINDERGARDEN</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="space-y-5 ltr:text-left rtl:text-right">
                                                ...
                                                <div class="mt-7">
                                                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:gap-12">
                                                        <span class="text-xl font-semibold">Elementary School Period</span>
                                                        <span class="font-semibold text-warning">小学生期</span>
                                                    </div>
                                                    <p class="mt-5 text-gray">休み時間は男子に混ざってサッカー三昧。運動得意スポーツ少女から徐々にオタクに磨きがかかり漫画・アニメ・ゲーム・ラジオの無限ループでとにかく忙しい。担任に頼んでコスプレイベントへ連れて行ってもらった時の写真</p>
                                                    <p class="mt-6 font-semibold">KAINOHANA ELEMENTARY SCHOOL</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-start w-full mx-auto">
                                        <div class="w-full md:w-1/2 ltr:pl-7 rtl:pr-7 ltr:md:pr-8 rtl:md:pl-8 ltr:lg:pr-14 rtl:lg:pl-14">
                                            <div class="space-y-5 ltr:text-left rtl:text-right ltr:md:text-right rtl:md:text-left">
                                                ...
                                                <div class="mt-7">
                                                    <div class="flex flex-col justify-end gap-4 lg:flex-row lg:items-center lg:gap-12">
                                                        <span class="font-semibold text-warning">中学生期</span>
                                                        <span class="text-xl font-semibold">Junior High School Period</span>
                                                    </div>
                                                    <p class="mt-5 text-gray">3年間バスケをしていて試合前は必ずスラダンを読んで挑みました（ベンチでしたけど笑）お笑いとファッションに目覚めたのもこの頃から。当時の美容師さんから前髪は短く不揃いなのがお洒落と言われ信じていました。原宿ファッションにハマりそして絵も描きだしてオタクって忙しい。</p>
                                                    <p class="mt-6 font-semibold">KURIGASAWA JUNIOR HIGH SCHOOL</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
